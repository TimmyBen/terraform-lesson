...
EOF
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo cp /home/ec2-user/.s3cfg /root/.s3cfg",          # Copy files to the root directory
      "sudo cp /home/ec2-user/nginx /etc/logrotate.d/nginx", # Copy files to Logrotate configuration folder
